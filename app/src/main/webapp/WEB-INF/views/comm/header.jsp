	...
	<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
		<div class="container-fluid">
			<a class="navbar-brand" href="${contextPath}/"> <img
				...
				height="60"
				srcset="https://static.wixstatic.com/media/6dedfe_ba1ac1618d0042b09b51df464bf1d6cf~mv2.png/v1/fill/w_90,h_60,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/%EC%95%8C%EC%97%A0%EC%86%8C%ED%94%84%ED%8A%B8_w_edited_edited.png"
				fetchpriority="high">
			</a>
					...
					<c:choose>
						<c:when test="${sessionScope.loginMember == null}">
							<li class="nav-item"><a class="nav-link"
								href="${contextPath}/signup">회원가입</a></li>
							<li class="nav-item"><a class="nav-link"
								href="${contextPath}/login">로그인</a></li>
						</c:when>
						<c:otherwise>
							<li class="nav-item"><a class="nav-link"
